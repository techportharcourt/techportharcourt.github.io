  ...
  <body>
    ...
    <section class="bg-gray">
      <nav class="navbar navbar-expand-lg navbar-light"> 
        <div class="container">
          <a class="navbar-brand" href="/"><img class="img-fliud logo-img" src="img/icons/logo.svg"></a>
          <div>
            <ul class="ml-auto">
              <li class="nav-item">
                <a href="#">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-7 col-md-10">
            <div class="blog-banner">
              <h6 class="clr-dk-blue">Tech PH</h6>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-7 col-md-10">
            <div class="blog-headlines">
              <h4 class="clr-black">
                Port Harcourt Design Community Meetup: The Big Picture
              </h4>
              <p class="mt-4">January, 03, 2020</p>

              <hr class="mt-5">


              <h4 class="clr-black mt-5">
                Port Harcourt Design Community Meetup: The Big Picture
              </h4>
              <p class="mt-4">January, 03, 2020</p>
